"""
Migrate phrase history to Gujarati format
Converts legacy keys ('japanese', 'telugu', 'korean') -> 'gujarati'
...
if HISTORY_FILE.exists():
    ...
    print(f"Migrated {updated_count} phrases to Gujarati format")
    if updated_count > 0:
    ...
    print("Ready for new Gujarati content generation")
else:
