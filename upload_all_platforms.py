"""
VELOCITY GUJARATI - Unified Social Media Upload Script
...
def get_latest_reel():
    ...
    return {
        ...
        "metadata": metadata,
        "category": metadata.get("category_english", "Gujarati Learning"),
...
def generate_caption(phrases, category, platform="facebook"):
    if platform == "facebook":
        caption_lines = [
            f"Learn Gujarati with VELOCITY GUJARATI!",
            f"",
            f"Category: {category}",
            f"",
            f"Master Gujarati one phrase at a time! Today's {category} lesson:",
            f""
        ]
        emojis = ["1", "2", "3", "4", "5"]
        for i, phrase in enumerate(phrases[:5], 0):
            ...
            caption_lines.append(f"   {phrase.get('gujarati', '')}")
        ...
        caption_lines.extend([
            ...
            f"Follow for daily Gujarati lessons!",
            f"",
        ])
        hashtags = [
            "#learngujarati", "#gujaratilessons", "#gujaratiforbeginners",
            "#languagelearning", "#gujarativocabulary", "#velocitygujarati",
            "#dailygujarati", "#gujarati", "#learnlanguages",
            "#gujaratiteacher", "#speakgujarati", "#gujaratipractice",
            "#bilingual", "#gujaratiwords", "#languagetips"
        ]
        ...
        hashtags = [
            "#learngujarati", "#gujaratilessons", "#gujaratiforbeginners",
            "#languagelearning", "#gujarativocabulary", "#velocitygujarati",
            "#dailygujarati", "#gujarati", "#learnlanguages", "#gujaratiteacher"
        ]
        caption_lines.extend(hashtags)
    return "\n".join(caption_lines)
...
def upload_to_all_platforms(video_path, caption, category, phrases=None):
    ...
    print("\n" + "=" * 80)
    print("VELOCITY GUJARATI - MULTI-PLATFORM UPLOAD")
    print("=" * 80)
...
def main():
    print("\n" + "=" * 80)
    print("VELOCITY GUJARATI - AUTOMATED UPLOAD")
    print("=" * 80)
